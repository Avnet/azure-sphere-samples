...
IoTHubClientAuthenticationState iotHubClientAuthenticationState =
...
// Constants
#define MAX_DEVICE_TWIN_PAYLOAD_SIZE 512 + 1024
                             ...
                             const char *modelId, void *connectionContext, AzureIoT_Callbacks cb)
{
    ...
    //  Setup the timer and handler to manage the IoTHub connection.  This period will be dynamically
    //  modified by the connection logic to improve connection management 
...
AzureIoT_Result AzureIoT_DeviceTwinReportState(const char *jsonState, void *context)
{
    ...
    if (iotHubClientAuthenticationState != IoTHubClientAuthenticationState_Authenticated) {
        ...
        return AzureIoT_Result_NotAuthenticated;
    }
    ...
    if (IoTHubDeviceClient_LL_SendReportedState(
        ...
        return AzureIoT_Result_SendReportedState_Failed;
    }
