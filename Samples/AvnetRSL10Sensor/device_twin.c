...
twin_t twinArray[] = {
    {.twinKey = "telemetryPollTime",.twinVar = &telemetryPollPeriod,.twinFd = NULL,.twinGPIO = NO_GPIO_ASSOCIATED_WITH_TWIN,.twinType = TYPE_INT,.active_high = true},
    {.twinKey = "authorizedMac1",.twinVar = &authorizedDeviceList[0][0],.twinFd = NULL,.twinGPIO = NO_GPIO_ASSOCIATED_WITH_TWIN,.twinType = TYPE_STRING,.active_high = true},
    {.twinKey = "authorizedMac2",.twinVar = &authorizedDeviceList[1][0],.twinFd = NULL,.twinGPIO = NO_GPIO_ASSOCIATED_WITH_TWIN,.twinType = TYPE_STRING,.active_high = true},
    {.twinKey = "authorizedMac3",.twinVar = &authorizedDeviceList[2][0],.twinFd = NULL,.twinGPIO = NO_GPIO_ASSOCIATED_WITH_TWIN,.twinType = TYPE_STRING,.active_high = true},
    {.twinKey = "authorizedMac4",.twinVar = &authorizedDeviceList[3][0],.twinFd = NULL,.twinGPIO = NO_GPIO_ASSOCIATED_WITH_TWIN,.twinType = TYPE_STRING,.active_high = true},
    {.twinKey = "authorizedMac5",.twinVar = &authorizedDeviceList[4][0],.twinFd = NULL,.twinGPIO = NO_GPIO_ASSOCIATED_WITH_TWIN,.twinType = TYPE_STRING,.active_high = true},
    {.twinKey = "authorizedMac6",.twinVar = &authorizedDeviceList[5][0],.twinFd = NULL,.twinGPIO = NO_GPIO_ASSOCIATED_WITH_TWIN,.twinType = TYPE_STRING,.active_high = true}
   };
        ...
        if (json_object_has_value(desiredProperties, twinArray[i].twinKey) != 0) {
            ...
            case TYPE_INT:
                *(int *)twinArray[i].twinVar =
                ...
                // Look sepcifically for the telemetryPollTime key
                if(strncmp(twinArray[i].twinKey, "telemetryPollTime", strlen("telemetryPollTime")) == 0){

                    struct timespec newTelemetryPeriod = {.tv_sec = telemetryPollPeriod, .tv_nsec = 0};
                    SetEventLoopTimerPeriod(sendTelemetryTimer, &newTelemetryPeriod);
                }
